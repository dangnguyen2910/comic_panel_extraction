...
def main() -> None: 
    ...
    # print(hough.dtype)
    plt.imshow(hough_binary, vmin=0, vmax=255)
    plt.plot(0, 383, 'go', markersize=2)
    # print(f'Pixel value: {hough_binary[383,]}')
    # print(hough_binary.shape)
    # plt.colorbar()
    ...
    plt.imshow(hough_classified, 'gray')
    plt.show()
